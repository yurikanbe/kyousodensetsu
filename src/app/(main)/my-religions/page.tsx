    ...
    return (
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white border border-stone-200 p-10 text-center">
          ...
          <Link href="/create">
            <button className="bg-stone-900 hover:bg-stone-800 text-white font-medium px-6 py-3 text-xs tracking-widest transition-colors">
              新しい宗教を創設する
            </button>
          </Link>
        </div>
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="flex items-center justify-between mb-4">
        ...
        <Link href="/create">
          <button className="bg-stone-900 hover:bg-stone-800 text-white font-medium px-4 py-2 text-xs tracking-widest transition-colors">
            新しく創設
          </button>
        </Link>
      </div>
